...
opcion_5 = Radiobutton(frame_botones, text="Negatiu", variable=funcionalidad_var, value="Negatiu", font=("Calibri light", 14), bg="#F2F2F2", activebackground="#F2F2F2", selectcolor="#F2F2F2")
opcion_5.pack(side=LEFT, padx=10)
